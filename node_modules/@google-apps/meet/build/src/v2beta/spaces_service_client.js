...
class SpacesServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('meet');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            memberPathTemplate: new this._gaxModule.PathTemplate('spaces/{space}/members/{member}'),
        ...
        this.descriptors.page = {
            listMembers: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'members'),
        };
    ...
    connectActiveConference(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createMember(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getMember(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteMember(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listMembers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listMembersStream(request, options) {
        ...
        return this.descriptors.page.listMembers.createStream(this.innerApiCalls.listMembers, request, callSettings);
    }
    /**
    ...
    listMembersAsync(request, options) {
        ...
        return this.descriptors.page.listMembers.asyncIterate(this.innerApiCalls['listMembers'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
