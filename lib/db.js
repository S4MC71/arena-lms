...
global._arenaDb = global._arenaDb || {
  ...
  schedules: [
    ...
    },
    {
      ...
      teacherName: 'Rahat Chowdhury', topic: 'SQL Injection: Error-based & Blind Attacks',
      status: 'UPCOMING', meetLink: null
    },
    {
      id: 'SCH-103', batchId: 'B2', batchName: 'Batch 2: API Security & Mobile Pentesting',
      day: 'Saturday', date: '2026-08-15', time: '9:30 PM - 11:30 PM',
      teacherName: 'Rahat Chowdhury', topic: 'REST API Authentication Bypasses & BOLA/IDOR',
      status: 'UPCOMING', meetLink: null
    },
    {
      id: 'SCH-104', batchId: 'B3', batchName: 'Batch 3: SOC & Threat Hunting',
      day: 'Sunday', date: '2026-08-16', time: '9:30 PM - 11:30 PM',
      teacherName: 'Rahat Chowdhury', topic: 'SIEM Log Analysis & Threat Detection in ELK',
      status: 'UPCOMING', meetLink: null
    }
  ],
